...
| 12   | QSPI AHB         | 0x68000000                  | 0x6FFFFFFF                               | 131072                     | Normal                | Write-Back/Allocate    | Write-Back/Allocate    | Yes        | No          | Read-Only         | Read-Only           |
...
/**************************************************************************/
    ...
    /* Size: 128MB, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back, write and read allocate, Shareable: Yes, Privileged Access:Read-Only, Unprivileged Access:Read-Only, Non-Executable */
    rasr[12]=0x170F0035UL;
