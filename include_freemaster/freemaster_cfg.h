...
//    FMSTR_SERIAL_S32_LPUART     -   S32 driver for LPUART peripheral
//    FMSTR_SERIAL_S32_LINFLEXD   -   S32 driver for LINFLEXD peripheral
// FMSTR_CAN      -   Standard CAN transport protocol (Used by various types of CAN peripherals)
//    FMSTR_CAN_S32_FLEXCAN       -   S32 driver for FlexCAN peripheral
...
#define FMSTR_REC_BUFF_SIZE     2048    // Built-in buffer size of recorder #0. Set to 0 to use runtime settings.
